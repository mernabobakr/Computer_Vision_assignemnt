...
def filterDFT(imageMatrix, filterMatrix):
   ...
   shiftedfilterDFT = fftshift(fft2(filterMatrix))
   misc.imsave("dft1.png", scaleSpectrum(shiftedfilterDFT))
   ...
   filteredDFT1 = shiftedDFT * shiftedfilterDFT
   misc.imsave("filtered-dft1.png", scaleSpectrum(filteredDFT1))
   return ifft2(ifftshift(filteredDFT1))
